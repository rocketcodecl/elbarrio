        ...
        <div className="profile-sheet-list">
          ...
          {items.map(item => {
            ...
            if (section === 'favorites') {
              return (
                <div className="profile-favorite-card" key={item.id}>
...
.profile-sheet-backdrop{position:absolute;inset:0;z-index:120;background:#f7faf7}.profile-sheet{width:100%;height:100%;min-height:0;background:#f7faf7;display:flex;flex-direction:column;animation:profilePageIn .24s cubic-bezier(.22,1,.36,1)}.profile-sheet header{min-height:82px;padding:32px 18px 12px;display:grid;grid-template-columns:40px 1fr 40px;align-items:center;gap:10px;background:#fff;border-bottom:1px solid #e1e7e3}.profile-sheet header>div{text-align:center}.profile-sheet header>span{width:40px}.profile-sheet header small{display:block;color:#159969;font-size:9px;font-weight:700}.profile-sheet header h2{margin:2px 0 0;font-size:17px}.profile-sheet header button{width:40px;height:40px;border-radius:50%;display:grid;place-items:center;background:#f7faf7;border:1px solid #dce2de;color:#1d211f}.profile-sheet-list{flex:1;min-height:0;overflow:auto;padding:14px 16px 110px;overscroll-behavior:contain}.profile-activity-row{width:100%;min-height:72px;display:flex;align-items:center;gap:11px;padding:10px 8px;border-bottom:1px solid #e1e7e3;text-align:left;color:#1d211f}.profile-activity-row>span:first-child{width:50px;height:50px;border-radius:12px;overflow:hidden;background:#e5f5ef;display:grid;place-items:center;flex:0 0 auto}.profile-activity-row img{width:100%;height:100%;object-fit:cover}.profile-activity-row div{flex:1;min-width:0}.profile-activity-row strong,.profile-activity-row small{display:block;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.profile-activity-row strong{font-size:12px}.profile-activity-row small{margin-top:4px;color:#68727b;font-size:9.5px}.profile-sheet-empty{margin-top:14px;padding:28px 20px;text-align:center;color:#68727b;font-size:12px;line-height:1.5;background:#fff;border:1px solid #dce2de;border-radius:16px}
.profile-favorite-card{position:relative;display:grid;grid-template-columns:96px minmax(0,1fr);min-height:112px;margin-bottom:12px;padding:8px;background:#fff;border:1px solid #dce2de;border-radius:17px;overflow:hidden;box-shadow:0 5px 16px rgba(31,63,46,.06)}.profile-favorite-cover{width:96px;height:96px;display:grid;place-items:center;overflow:hidden;border-radius:12px;background:#e5f5ef;font-size:30px}.profile-favorite-cover img{width:100%;height:100%;object-fit:cover}.profile-favorite-copy{min-width:0;padding:10px 35px 8px 13px;align-self:center}.profile-favorite-copy small,.profile-favorite-copy strong,.profile-favorite-copy>span{display:block}.profile-favorite-copy small{color:#159969;font-size:9px;font-weight:800;text-transform:uppercase;letter-spacing:.04em}.profile-favorite-copy strong{margin-top:5px;color:#1d211f;font-size:15px;line-height:1.25;white-space:normal}.profile-favorite-copy>span{margin-top:6px;color:#68727b;font-size:11px;line-height:1.35}.profile-favorite-heart{position:absolute;top:13px;right:13px;color:#8b5cf6;font-size:18px;line-height:1}
