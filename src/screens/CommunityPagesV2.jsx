...
const s={
  screen:{width:'100%',height:'100%',background:C.fondo,fontFamily:T.font,display:'flex',flexDirection:'column',overflow:'hidden'},header:{minHeight:72,boxSizing:'border-box',background:'rgba(255,255,255,.94)',backdropFilter:'blur(12px)',borderBottom:`1px solid ${C.borde}`,display:'grid',gridTemplateColumns:'40px 1fr 40px',alignItems:'center',gap:10,padding:'calc(env(safe-area-inset-top, 0px) + 14px) 16px 10px',flexShrink:0,zIndex:20},headerBtn:{width:38,height:38,padding:0,borderRadius:'50%',background:'#fff',border:`1px solid ${C.borde}`,display:'grid',placeItems:'center',color:C.texto},headerTitle:{margin:0,textAlign:'center',fontSize:15,fontWeight:700,color:C.texto,whiteSpace:'nowrap',overflow:'hidden',textOverflow:'ellipsis'},headerBalance:{width:38,height:38},scroll:{flex:1,minHeight:0,overflowY:'auto',padding:'20px 16px 100px',WebkitOverflowScrolling:'touch'},
