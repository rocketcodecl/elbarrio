...
- Cada campaña admite de una a tres imágenes ordenadas. La app las alterna automáticamente cada 3,6 segundos con fundido y gesto lateral; una sola imagen conserva el comportamiento estático. El panel de galería fue publicado en `https://admin.elbarrio.lat/`; el HTML, `index-5l2QfTIY.js` e `index-BlV3SA3u.css` coinciden byte por byte con el build local y responden HTTP 200. No se ha sincronizado Capacitor ni generado una nueva entrega móvil con esta ampliación.
- APK de prueba generado después de sincronizar Capacitor: `release/android/el-barrio-prueba-20260812/el-barrio-prueba-publicidad.apk`. Usa el paquete `lat.elbarrio.app`, versión `1.0.1` (`versionCode 2`), pesa aproximadamente 19 MB y su SHA-256 es `2f79b080bca53ccb5fe5d56e8ea59249ac08415c5606933323c8312a3afdc0c9`. `apksigner` confirmó firma debug válida mediante APK Signature Scheme v2. Es solo para instalación y prueba directa; no sirve como entrega firmada para Google Play y no reemplaza el AAB 1.0.1 existente.
